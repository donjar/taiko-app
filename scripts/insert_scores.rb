...
Chart.find_each do |chart|
  ...
  params = { score: score, ryo: ryo, ka: ka, fuka: fuka, rolls: rolls, crown: crown.nil? ? nil : "https://donderhiroba.jp/#{crown}", best_score: best_score.nil? ? nil : "https://donderhiroba.jp/#{best_score}" }
